...
Arguments:
    ...
    4) Name of first part of output filename, for instance jaccard_fisher or jaccard_arithmetric_average
"""
import sys
...
def write_jaccard(jaccard_index, n, outfile_name):
    ...
    outfile.write(sys.argv[2]+'\t'+str(jaccard_index)+'\n')
    outfile.close()
...
if __name__ == '__main__':
    ...
    outfile_name = sys.argv[4] + str(n) + ".txt"
