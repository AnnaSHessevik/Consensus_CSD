...
if __name__ == '__main__':
    ...
    #Make plots
    plt.rcParams['font.size'] = '11' #Change font size
    ...
    make_plots(degrees_arithmetic, degrees_fisher, "firebrick", "Degree in CSD network based on weighted \nuntransformed correlation coefficients", "Degree in CSD network based on Fisher's Z \ntransformed correlation coefficinets", "degree_vs_degree_CSD_v2.png", 3, degrees_a_specific, degrees_f_specific, "lightcoral")
