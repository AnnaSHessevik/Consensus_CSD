# -*- coding: utf-8 -*-
"""
Created on Wed Nov 3 11:57:39 2021

@author: annas
This script creates two data sets with control or case (biploar 
disorder) samples from the GSE5388.
"""
#Open input files
raw_data = open("GSE5388_series_matrix.txt")
mapping_file = open("mapping_GSE5388.txt")

#Output files
bp_file = open("bipolar_disorder_GSE5388_probes.txt", 'w')
control_file = open("control_GSE5388_probes.txt", 'w')
...
for line in mapping_file:
    ...
    disorder = line_split[2].split('_')[0]
    if (disorder == "B"):
        bp.add(line_split[0])
    elif (disorder == "C"):
